class JpegBitWriter:
    ...
    def write_bits(self, bits_to_write, padding=True):
        for b in bits_to_write:
            self.write_bit(1 if b == 1 or b else 0, padding)
